    ...
    <form className='flex justify-center gap-2 mb-2'>
      ...
      {props.submit && (
        <>
          <button
            type='submit'
            className='w-full items-center py-1.5 px-2 text-sm font-medium text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800'
          >
            {props.submit}
          </button>
        </>
