...
function App(props) {
  ...
  return (
      <div className="bg-black rounded-lg h-full w-full flex items-center justify-center">
        <div className=" h-full cursor-pointer text-white w-full gap-3 flex items-start justify-center py-3 pr-4 pl-3">
          ...
          <div className="flex flex-col w-full items-center justify-start gap-2">
              ...
              <div className="flex items-center justify-center gap-2">
                <div className="flex flex-col items-start ">
                  <div className="name side flex justify-center items-center gap-0.5 ">
                    <div className="name font-semibold hover:underline text-xs">Elon Musk</div>
                    <div className="blue tick w-4">
                      <img src={bluetick} className="w-full" />
                    </div>
                    <div className="flex justify-center items-center gap-1 ">
                      <div className="@name text-[#65696e] text-xs">@elonmusk</div>
            ...
            <div className="w-full">
              <p>DogeCoin 🚀: The cryptocurrency that started as a meme and became a global sensation! With its friendly Shiba Inu mascot and a growing community of believers 🐕💰</p>
              {props.last?(<div className="w-full py-2">{props.last}</div>):null}
            </div>
